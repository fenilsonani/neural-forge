...
from neural_arch.exceptions import NeuralArchError, OptimizerError
...
class TestSGDComprehensive:
    ...
    def test_sgd_parameter_shapes(self):
        ...
        param_scalar = Parameter(
            np.array([5.0], dtype=np.float32), name="scalar"
        )  # 1D array instead
    ...
    def test_sgd_inheritance_and_attributes(self):
        ...
        from neural_arch.core import Optimizer
